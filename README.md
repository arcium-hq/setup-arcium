...
./scripts/sync-version.sh 0.5.4

# Create release branch
git checkout -b v0.5.4
git add -A
git commit -m "chore: bump arcium to v0.5.4"
git push -u origin v0.5.4

# Create PR - after merge, auto-release creates GitHub release
gh pr create --title "Release v0.5.4" --body "Update Arcium to v0.5.4"
```
